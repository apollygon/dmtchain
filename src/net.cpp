...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DMTchain " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dmtchaintools.com", "dnsseed.dmtchaintools.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"dmtchaintools.com", "testnet-seed.dmtchaintools.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DMTchain is probably already running."), addrBind.ToString().c_str());
        else
